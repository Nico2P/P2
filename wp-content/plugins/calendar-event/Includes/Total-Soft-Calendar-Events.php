	...
	<table class="Total_Soft_AMOTable1">
	 	<?php for($i=0;$i<count($TotalSoftEvCount);$i++){
	 		...
	 		<tr id="Total_Soft_AMOTable1_Calendar_tr_<?php echo $TotalSoftEvCount[$i]->id;?>">
				...
				<td title="Clone"><i class="Total_Soft_icon totalsoft totalsoft-file-text" onclick="TotalSoftCal_EditCl(<?php echo $TotalSoftEvCount[$i]->id;?>)"></i></td>
				<td title="Edit"><i class="Total_Soft_icon totalsoft totalsoft-pencil" onclick="TotalSoftCal_EditEv(<?php echo $TotalSoftEvCount[$i]->id;?>)"></i></td>
				<td title="Delete">
					<i class="Total_Soft_icon totalsoft totalsoft-trash" onclick="TotalSoftCal_DelEv(<?php echo $TotalSoftEvCount[$i]->id;?>)"></i>
